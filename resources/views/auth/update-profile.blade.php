                ...
                @if(auth()->user()->hasRole('patient'))
                    <ul class="nav nav-tabs mb-3 w-100" id="patientTab" role="tablist">
                        <li class="nav-item flex-fill text-center" role="presentation">
                            <button class="nav-link active w-100" id="personal-tab" data-bs-toggle="tab" data-bs-target="#personal" type="button" role="tab" aria-controls="personal" aria-selected="true">Informações Pessoais</button>
                        </li>
                        <li class="nav-item flex-fill text-center" role="presentation">
                            <button class="nav-link w-100" id="address-tab" data-bs-toggle="tab" data-bs-target="#address" type="button" role="tab" aria-controls="address" aria-selected="false">Endereço</button>
                        </li>
                        <li class="nav-item flex-fill text-center" role="presentation">
                            <button class="nav-link w-100" id="revoke-access-tab" data-bs-toggle="tab" data-bs-target="#revoke-access" type="button" role="tab" aria-controls="revoke-access" aria-selected="false">Revogar Acesso</button>
                        </li>
                    </ul>
