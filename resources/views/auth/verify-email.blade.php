...
@section('content')
    <div class="container position-relative" style="min-height: 80vh;">
        <form method="POST" action="{{ route('logout') }}"
            class="position-absolute top-0 start-0 mt-3 ms-2 d-flex align-items-center gap-1 shadow" style="z-index:10;">
            @csrf
        ...
        <div class="d-flex align-items-center justify-content-center" style="min-height: 80vh;">
            <div class="card shadow-lg p-4" style="max-width: 400px; width: 100%;">
                ...
                <small class="text-muted d-block text-center mb-3">Caso não tenha recebido o email, clique no botão abaixo
                    para reenviar.</small>
