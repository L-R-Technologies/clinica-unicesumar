...
<head>
    ...
    <title>Clínica Unicesumar</title>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary mb-4" style="min-height: 80px;">
            <div class="container-fluid">
                <a class="navbar-brand d-flex align-items-center" href="/home">
                    <img src="{{ asset('imgs/unicesumar-logo.png') }}" alt="Unicesumar Logo"
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item">
                            <a class="btn btn-light text-primary px-4 fw-bold"
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        @else
                            ...
                            @if (auth()->user()->hasRole('patient'))
                                <li class="nav-item d-flex align-items-center">
                                    <a class="nav-link text-light fw-bold px-3 me-2 d-flex align-items-center gap-2 h-100"
                                        href="{{ route('patient-exams.index') }}">
                            ...
                            <li class="nav-item dropdown d-flex align-items-center">
                                <a class="nav-link dropdown-toggle d-flex align-items-center justify-content-center px-2"
                                    href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown"
                                    aria-expanded="false" style="min-width: 48px;">
                                    <i class="fa fa-user-circle fa-2x"></i>
                                </a>
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                    <li>
                                        <a class="dropdown-item fw-bold text-primary d-flex align-items-center gap-2"
                                    ...
                                    <li>
                                        <a class="dropdown-item fw-bold text-primary d-flex align-items-center gap-2"
                                            href="{{ route('user.password-edit', ['user' => auth()->user()->id]) }}">
                                            Editar Senha
                                        </a>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <form method="POST" action="{{ route('logout') }}">
                                            @csrf
                                            <button
                                                class="dropdown-item fw-bold text-danger d-flex align-items-center gap-2"
                                                type="submit">
                                                Sair
                                            </button>
                                        </form>
