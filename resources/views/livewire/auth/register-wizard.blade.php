        ...
        @if($step === 1)
            <div class="register-step">
                <div class="mb-3">
                    ...
                    <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" wire:model.defer="name" autofocus>
                ...
                <div class="mb-3">
                    ...
                    <input id="password" type="password" class="form-control @error('password') is-invalid @enderror" wire:model.defer="password" placeholder="senha@123456">
                    @error('password') <span class="invalid-feedback">{{ $message }}</span> @enderror
                </div>
                <div class="mb-3">
                    <label for="password_confirmation" class="form-label">Confirmação da senha</label>
                    <input id="password_confirmation" type="password" class="form-control" wire:model.defer="password_confirmation" placeholder="senha@123456">
                </div>
                <div class="d-grid">
            ...
            <div class="register-step">
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="date" wire:model.defer="birth_date" id="birth_date" class="form-control @error('birth_date') is-invalid @enderror">
                        @error('birth_date') <span class="invalid-feedback">{{ $message }}</span> @enderror
                    </div>
                    <div class="col-md-6 mb-3">
                        <label for="sex">Sexo</label>
                        <select wire:model.defer="sex" id="sex" class="form-control @error('sex') is-invalid @enderror">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" wire:model.defer="rg" id="rg" class="form-control @error('rg') is-invalid @enderror">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" wire:model.defer="ethnicity" id="ethnicity" class="form-control @error('ethnicity') is-invalid @enderror">
                        @error('ethnicity') <span class="invalid-feedback">{{ $message }}</span> @enderror
                    </div>
                    <div class="col-md-6 mb-3">
            ...
            <div class="register-step">
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" wire:model.defer="street" id="street" class="form-control @error('street') is-invalid @enderror">
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" wire:model.defer="number" id="number" class="form-control @error('number') is-invalid @enderror">
                        @error('number') <span class="invalid-feedback">{{ $message }}</span> @enderror
                    </div>
                    <div class="col-md-8 mb-3">
                        <label for="neighborhood">Bairro</label>
                        <input type="text" wire:model.defer="neighborhood" id="neighborhood" class="form-control @error('neighborhood') is-invalid @enderror">
                        @error('neighborhood') <span class="invalid-feedback">{{ $message }}</span> @enderror
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <label for="complement">Complemento</label>
                        <input type="text" wire:model.defer="complement" id="complement" class="form-control @error('complement') is-invalid @enderror">
                        @error('complement') <span class="invalid-feedback">{{ $message }}</span> @enderror
                    </div>
                    <div class="col-md-6 mb-3">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" wire:model.defer="state" id="state" class="form-control @error('state') is-invalid @enderror">
                ...
                <div class="mb-3">
                    <div class="form-check">
                        <input type="checkbox" wire:model.defer="lgpd_consent" id="lgpd_consent" class="form-check-input @error('lgpd_consent') is-invalid @enderror" value="1">
