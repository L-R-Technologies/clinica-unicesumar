                        ...
                        <div class="row g-3">
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control" id="search"
                                    wire:model.live.debounce.300ms="search" placeholder="Digite o nome ou email...">
                            </div>
                            <div class="col-md-3">
                                            ...
                                            <div class="d-flex flex-wrap flex-md-nowrap align-items-center gap-2 w-100">
                                                <div
                                                    ...
                                                    <div class="d-flex flex-column align-items-start"
                                                        ...
                                                        @else
                                                            <span
                                                                class="badge bg-secondary">{{ ucfirst($user->role) }}</span>
                                                        @endif
                                                    </div>
                                                    <div class="d-flex flex-column align-items-start"
                                                        style="min-width: 100px;">
                                                        ...
                                                        @if ($user->active)
                                                            <span class="badge bg-success"><i
                                                                    class="fas fa-check-circle"></i> Ativo</span>
                                                        @else
                                                            <span class="badge bg-danger"><i
                                                                    class="fas fa-times-circle"></i> Inativo</span>
                                                        @endif
                                                    </div>
                                                    <div class="d-flex flex-column align-items-start"
                                                        style="min-width: 120px;">
                                                        ...
                                                        <span
                                                            class="text-muted small">{{ $user->created_at->format('d/m/Y H:i') }}</span>
                                                    </div>
                                                </div>
                                                <div class="d-flex align-items-center ms-auto mt-2 mt-md-0">
                                                    <div class="btn-group" role="group">
                                                        <button type="button" class="btn btn-sm btn-outline-secondary"
                                                            ...
                                                            <i
                                                                class="fas {{ $user->active ? 'fa-user-slash' : 'fa-user-check' }}"></i>
                                                        </button>
