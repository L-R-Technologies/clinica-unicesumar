                ...
                <div class="card mx-auto" style="max-width: 700px;">
                    <div class="card-body">
                        ...
                        <p>
                            ...
                            de nossos pacientes, em conformidade com a Lei Geral de Proteção de Dados (Lei nº 13.709/2018 -
                            LGPD).
                        </p>
                        ...
                        <ul>
                            ...
                            <li><strong>Cumprimento de obrigação legal:</strong> Conforme exigências do CFM e outros órgãos
                            </li>
                        </ul>
                        ...
                        <p><strong>Importante:</strong> Não vendemos, alugamos ou transferimos seus dados para terceiros
                        ...
                        <ul>
                            ...
                            <li><strong>Anonimização, bloqueio ou eliminação:</strong> De dados desnecessários ou excessivos
                            </li>
                            <li><strong>Portabilidade:</strong> Receber seus dados em formato estruturado</li>
                            <li><strong>Revogação do consentimento:</strong> Quando aplicável</li>
                            <li><strong>Informação sobre compartilhamento:</strong> Saber com quem seus dados são
                                compartilhados</li>
                        </ul>

                        <h3>9. Como Exercer Seus Direitos</h3>
                        <p>Para exercer seus direitos ou esclarecer dúvidas sobre esta política, entre em contato conosco:
                        </p>
                        <ul>
